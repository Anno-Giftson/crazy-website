...
// when page loads, set up runaway button
...
["copy","paste","cut"].forEach(evt => {
  freezeInput.addEventListener(evt, e => {
    e.preventDefault();
    alert(`No ${evt}ing allowed!`);
  });
});
...
// Admin popup and open admin page
